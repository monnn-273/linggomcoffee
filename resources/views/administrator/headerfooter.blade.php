...
<html lang="en">
<head>
     <title>Linggom Coffee - Admin</title>
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         <li><a href="#home" class="smoothScroll">Profile</a></li>
                         <li><a href="#about" class="smoothScroll">Order List</a></li>
                         <li><a href="#contact" class="smoothScroll">Produk</a></li>
                    </ul>
