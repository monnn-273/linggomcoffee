...
<body>
    ...
    <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
            ...
            <div class="owl-carousel owl-theme">
                    ...
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-8 col-sm-12">
                                    <h3>Linggom Coffee</h3>
                                    <h1>Kopi robusta berkualitas, kebangaan Dairi</h1>
                ...
                <div class="item item-second">
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-8 col-sm-12">
                                    <h3>Ngopi dulu</h3>
                                    <h1>Belum keren kalau belum rasain kopi Sidikalang, Sob!</h1>
                                    <a href="#menu" class="section-btn btn btn-default smoothScroll">Lihat Produk</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item item-third">
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-8 col-sm-12">
                                    <h3>Discover the Sidikalang Pride!</h3>
                                    <h1>Enjoy our Sidikalang special coffee</h1>
                                    <a href="#contact" class="section-btn btn btn-default smoothScroll">Buat Pesanan</a>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <!-- ABOUT -->
     <!-- Alternative to the blog section is top activity description that would make this website more interesting  -->
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              <div class="section-title wow fadeInUp" data-wow-delay="0.2s">
                                   <h4>Blog Section : few top blog written by owner</h4>
                                   <h2>Title of the Blog 1</h2>
                              </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                              <h2>Wonder About the Founder?</h2>
                              <h4>A representative of Inspire Youth </h4>
                         </div>
                    </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-offset-2 col-md-8 col-sm-12">
                         ...
                         <a href="#contact" class="section-btn btn btn-default smoothScroll">Pesan Sekarang</a>
                    </div>
                         ...
                         <div class="col-md-12 col-sm-12">
                              <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                                   <h2>Contact Us</h2>
                                    <p>
                                        <ul>
                                            <li>Instagram icon and link</li>
                                            <li>Tiktok icon and link</li>
                                            <li>Whatsapp contact</li>
                                            <li>Another socmed to mention</li>
                                        </ul>
                                    </p>
                              </div>
                         </div>
